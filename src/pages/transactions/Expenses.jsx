  ...
  return (
    <MainLayout header={breadcrumb}>
      <div className="space-y-6">
        ...
        {/* Expenses Summary */}
        <ExpensesSummary pagination={pagination} filters={filters} />
        ...
        <div ref={tableContainerRef}>
          <ExpensesTable expenses={expenses} loading={loading} onSort={handleSort} filters={filters} pagination={pagination} onDelete={handleDelete} onView={handleView} />
        </div>

        {/* Pagination */}
        <ExpensesPagination pagination={pagination} onPageChange={handlePageChange} onLimitChange={handleLimitChange} />
