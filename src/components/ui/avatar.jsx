...
function AvatarFallback({ className, ...props }) {
  return <AvatarPrimitive.Fallback data-slot="avatar-fallback" className={cn("bg-gray-200 flex size-full items-center justify-center rounded-full", className)} {...props} />;
}
