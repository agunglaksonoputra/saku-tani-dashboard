...
export const useExpensesForm = () => {
    ...
    const validateForm = () => {
        ...
        if (formData.shipping_cost && !validator.isFloat(formData.shipping_cost, {min: 0})) {
            return "Ongkir harus berupa angka >= 0";
        }
        if (formData.discount && !validator.isFloat(formData.discount, {min: 0})) {
            return "Diskon harus berupa angka >= 0";
        }
